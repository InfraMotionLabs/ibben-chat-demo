...
const ChatbotIcon = ({
  ...
  return (
    <div
      ...
      className="rounded-full cursor-pointer text-[#619138] border border-[#416125] z-10 hover:scale-105 shadow-md shadow-neutral-700/60 transition-transform hover:text-[#619138] duration-100 "
    >
      <svg
